...
merge_finaldataset_trim_salary = merge_finaldataset[['cust_id', 'credit/debit','amount','transaction_count']]
...
merge_finaldataset_trim_salary_withoutcustid = merge_finaldataset_trim_salary[['totalnoofdebits','totaldebit' ,'totalnoofcredits','totalcredit']] #customer id is not actually a variable
...
'totalnoofdebits' : pd.Series([2], index=[0]),
                   'totaldebit': pd.Series([34909],index=[0]),
                   'totalnoofcredits':pd.Series([1],index=[0]),
                   'totalcredit':pd.Series([4500],in00dex=[0]),
                   
                   
                   })
print(testing_set)
print("going to predict")
outlier_analysis.predict(testing_set[['totalnoofdebits','totaldebit','totalnoofcredits','totalcredit']]) # again, customer id is not actually a variable
